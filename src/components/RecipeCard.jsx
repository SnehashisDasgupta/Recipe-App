...
const RecipeCard = ({ recipe, bg, badge }) => {
    ...
    const [isFavorite, setIsFavourite] = useState(localStorage.getItem('favorites')?.includes(recipe.label));
    ...
    return (
        <div className={`flex flex-col rounded-md ${bg} overflow-hidden p-3 relative`}>
            ...
            <p className="my-2">
                {/* capitalize the 1st letter of the cuisineType name */}
